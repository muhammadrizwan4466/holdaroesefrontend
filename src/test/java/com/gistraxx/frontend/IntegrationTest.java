...
import com.gistraxx.frontend.HoldaroesefrontendApp;
import com.gistraxx.frontend.config.EmbeddedMongo;
...
@SpringBootTest(classes = { HoldaroesefrontendApp.class, TestSecurityConfiguration.class })
@EmbeddedMongo

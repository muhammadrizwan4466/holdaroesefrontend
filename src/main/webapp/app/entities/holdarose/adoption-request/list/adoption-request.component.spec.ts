...
describe('AdoptionRequest Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'adoption-request', component: AdoptionRequestComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.adoptionRequests?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

...
describe('Foundation Management Component', () => {
  let comp: FoundationComponent;
  let fixture: ComponentFixture<FoundationComponent>;
  let service: FoundationService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'foundation', component: FoundationComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FoundationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.foundations?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
